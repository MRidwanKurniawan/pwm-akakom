...
// CONCATENATED MODULE: ./src/pages/ionic-official-components/card/card-image/card-image.ts
...
var card_image_CardImagePage = (function () {
...
// CONCATENATED MODULE: ./src/pages/ionic-official-components/card/card-image/card-image.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CardImagePageModule", function() { return card_image_module_CardImagePageModule; });
var card_image_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var card_image_module_CardImagePageModule = (function () {
    function CardImagePageModule() {
    }
    CardImagePageModule = card_image_module___decorate([
        Object(core["I" /* NgModule */])({
            declarations: [
                card_image_CardImagePage,
            ],
            imports: [
                ionic_angular["e" /* IonicPageModule */].forChild(card_image_CardImagePage),
            ],
            exports: [
                card_image_CardImagePage
            ]
