...
// CONCATENATED MODULE: ./src/pages/ionic-official-components/card/card-badge/card-badge.ts
...
var card_badge_CardBadgePage = (function () {
...
// CONCATENATED MODULE: ./src/pages/ionic-official-components/card/card-badge/card-badge.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CardBadgePageModule", function() { return card_badge_module_CardBadgePageModule; });
var card_badge_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var card_badge_module_CardBadgePageModule = (function () {
    function CardBadgePageModule() {
    }
    CardBadgePageModule = card_badge_module___decorate([
        Object(core["I" /* NgModule */])({
            declarations: [
                card_badge_CardBadgePage,
            ],
            imports: [
                ionic_angular["e" /* IonicPageModule */].forChild(card_badge_CardBadgePage),
            ],
            exports: [
                card_badge_CardBadgePage
            ]
